...
使用方法:
    ...
    # 同时启动相机驱动
    ros2 launch perception_bringup multi_camera_3d_rviz.launch.py use_camera_driver:=true
    
    # 性能模式
    ros2 launch perception_bringup multi_camera_3d_rviz.launch.py perf_mode:=3
    
    # 只显示 top 相机
    ros2 launch perception_bringup multi_camera_3d_rviz.launch.py enable_chassis:=false
    
    # 不启动 RViz（仅发布可视化数据）
    ros2 launch perception_bringup multi_camera_3d_rviz.launch.py rviz:=false
"""
