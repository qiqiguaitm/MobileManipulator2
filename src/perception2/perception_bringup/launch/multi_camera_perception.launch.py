...
使用方法:
    ...
    ros2 launch perception_bringup multi_camera_perception.launch.py use_camera_driver:=true
    ros2 launch perception_bringup multi_camera_perception.launch.py enable_chassis:=false
    ros2 launch perception_bringup multi_camera_perception.launch.py auto_detect_rate:=3.0
"""
