...
使用方法:
    ...
    ros2 launch perception_bringup scene_perception_3d.launch.py enable_tracker:=true
    ros2 launch perception_bringup scene_perception_3d.launch.py enable_rviz_viz:=true
"""
...
def generate_launch_description():
    ...
    # 外参目录 - 默认使用 perception_bringup/config
    bringup_share = get_package_share_directory('perception_bringup')
