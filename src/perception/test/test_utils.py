...
class TestLogThrottle:
    ...
    def test_should_log_first_call(self):
        """第一次调用应该返回 True"""
        from perception.utils import LogThrottle
...
class TestQoSProfiles:
    ...
    def test_sensor_qos_exists(self):
        ...
        from perception.utils import SENSOR_QOS
    ...
    def test_latched_qos_exists(self):
        ...
        from perception.utils import LATCHED_QOS
    ...
    def test_default_qos_exists(self):
        ...
        from perception.utils import DEFAULT_QOS
        from rclpy.qos import QoSReliabilityPolicy
...
class TestPointCloud2Parsing:
    ...
    def test_parse_empty_pointcloud(self):
        """测试解析空点云"""
        from perception.utils import parse_pointcloud2_fast
...
class TestTimeUtilities:
    ...
    def test_stamp_to_sec(self):
        """测试时间戳转秒"""
        from perception.utils import stamp_to_sec
    ...
    def test_sec_to_stamp(self):
        """测试秒转时间戳"""
        from perception.utils import sec_to_stamp
